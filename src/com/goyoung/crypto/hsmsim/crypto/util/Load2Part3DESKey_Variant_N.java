...
public class Load2Part3DESKey_Variant_N {
	...
	public static byte[] Go(String s_KEY_HexString, int i_Variant)
		...
		byte[] b_Atalla_Variant = DatatypeConverter.parseHexBinary(ReturnVariantFlags.Go(i_Variant));
		...
		byte[] vKeyL = CryptoUtils.xor(keyL, b_Atalla_Variant);
		byte[] vKeyR = CryptoUtils.xor(keyR, b_Atalla_Variant);

...
public class CryptoUtils {
    ...
    */
    ...
    public static String formatDouble(double d, int len) {
        ...
        try {
            if (len > 3)
                prefix = CryptoUtils.padleft(prefix,len-3,' ');
            suffix = CryptoUtils.zeropad(suffix, 2);
        } catch (Exception e) {
            // should not happen
        }
    ...
    public static String protect (String s) {
        ...
        try {
            ...
            if (charCount == 2 ) {
                ...
                s = CryptoUtils.padright(s, len, '_');
            }
        } catch (Exception e){
    ...
    public static String formatAmountConversionRate(double convRate) throws Exception {
        ...
        if (x > 9)
            bds = CryptoUtils.zeropad(bds, bds.length() + x - 9);
        String ret = CryptoUtils.zeropadRight(bds, 7);
        return Math.min(9, x) + CryptoUtils.takeFirstN(ret, 7);
    }
     ...
     * @see org.CryptoUtils.iso.ISOUtil#commaDecode(String)
     ...
     * @see org.CryptoUtils.iso.ISOUtil#commaEncode(String[])

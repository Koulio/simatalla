...
import com.goyoung.crypto.hsmsim.commands.crypto.Encrypt_PIN_ANSI_Format_0;
...
import com.goyoung.crypto.hsmsim.commands.utility.ReturnIPAddressofNSP;
...
public class CommandProcessor {
	...
	public static String Go(String sCommand) throws Exception {
		...
		//TODO finish implementing TranslateWorkingKeyforDistributiontoNonAtallaNode
		...
		if (sCommand.contains("<30#")) {
			return Encrypt_PIN_ANSI_Format_0.Go(sCommand);
		}
		...
		if (sCommand.contains("<1221#>")) {
			return ReturnIPAddressofNSP.Go(sCommand);
		}
